...
import {
  ...
  useUserCourtBookings,
} from '@/hooks/api/useCourt.ts'
...
function RouteComponent() {
  ...
  const { bookings, refetch } = useUserCourtBookings()
  const {
    isLoading: isUpdateBookingStatusLoading,
    mutateUpdateBookingStatus,
    isSuccess: isUpdateBookingStatusSuccess,
    setIsSuccess: setIsUpdateBookingStatusSuccess,
  } = useUpdateBookingStatus()
  ...
  useEffect(() => {
    if (!isUpdateBookingStatusLoading && isUpdateBookingStatusSuccess) {
      refetch()
      setIsUpdateBookingStatusSuccess(false)
    }
  }, [isUpdateBookingStatusSuccess, isUpdateBookingStatusLoading])
